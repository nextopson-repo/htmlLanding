...
fetch(headerPath)
  ...
  .then((data) => {
    ...
    if (typeof initHeaderEvents === 'function') {
      initHeaderEvents();
    } // Optional: if you have JS for header
  });
...
function initHeaderEvents() {
  ...
  console.log('menuIcon:', document.getElementById('menuIcon'));
  console.log('heroSection:', document.getElementById('heroSection'));
  console.log('productToggleMobile:', document.getElementById('productToggleMobile'));
  console.log('productDropdownMobile:', document.getElementById('productDropdownMobile'));
  console.log('arrowIcon:', document.getElementById('arrowIcon'));
  console.log('androidicon:', document.querySelector('.androidicon'));
  console.log('playStore:', document.querySelector('.playStore'));
  console.log('appleicon:', document.querySelector('.appleicon'));
  console.log('appStore:', document.querySelector('.appStore'));
  console.log('downloadWrapper:', document.querySelector('.downloadWrapper'));
  ...
  let isOpen = false;
  if (menuToggle && mobileMenu && menuIcon && heroSection) {
...
function alertCTA() {
 ...
 function toggleFaq(el) {
  ...
  // Categery icons
    ...
    // Dynamically load the header into #header-container
    document.addEventListener('DOMContentLoaded', function() {
      fetch('../component/header.html')
        .then(response => response.text())
        .then(data => {
          document.getElementById('header-container').innerHTML = data;
          // After header is loaded, initialize header JS
          if (typeof initHeaderEvents === 'function') {
            initHeaderEvents();
          }
        });
